#alejandro briones cse475 lab 2 decisionTree.py
...
# Features
X = pima_df.drop('Outcome', axis=1) # added
 
# Target variable
y = pima_df['Outcome'] #added
...
for k in range(2, 11):
    ...
    skfold = StratifiedKFold(n_splits=k, random_state=100, shuffle=True) # ADDED : StratifiedKFold() - use random_state = 100, shuffle = True
